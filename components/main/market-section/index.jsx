			...
			<div className={`${style.market} container-spacing`}>
				...
				<div className={style.market_list}>
						<div className={style.market_list_piece}>
							...
							<p>Allows for quick reactions to price changes and real-time trading operations</p>
						</div>
						<div className={style.market_list_piece}>
						...
						<div className={style.market_list_piece}>
							...
							<p>
								Guarantees assistance and consultations from specialists at any time 
								of day, which is especially important when issues or questions arise
							</p>
						</div>
						<div className={style.market_list_piece}>
							<h3>Convenient financial operations</h3>
							<p>
								Ensures fast and convenient fund withdrawals, as well as transparent 
